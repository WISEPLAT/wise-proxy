...
func (r *RPCClient) GetWork() ([]string, error) {
	...
	rpcResp, err := r.doPost(r.Url.String(), "wsh_getWork", params)
	var reply []string
	if err != nil {
		return reply, err
	}
...
func (r *RPCClient) GetPendingBlock() (GetBlockReply, error) {
	...
	rpcResp, err := r.doPost(r.Url.String(), "wsh_getBlockByNumber", params)
...
func (r *RPCClient) SubmitBlock(params []string) (bool, error) {
	rpcResp, err := r.doPost(r.Url.String(), "wsh_submitWork", params)
	var result bool
	if err != nil {
		return false, err
	}
...
func (r *RPCClient) SubmitHashrate(params interface{}) (bool, error) {
	rpcResp, err := r.doPost(r.Url.String(), "wsh_submitHashrate", params)
	var result bool
	if err != nil {
		return false, err
	}
